...
//Creando una referencia reactiva para almancenar el plan seleccionado
const selectedPlan=ref(null)
const plans = ref (['El cafetero', 'Amigo', 'El lechero']);
...
console.log('Termina de ejecutar el scrit setup 🥳');
